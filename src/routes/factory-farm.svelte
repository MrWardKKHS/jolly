            ...
            <div class="row">
               <div class="wdt-100">
                  <div class="col-md-12">
                     ...
                     <img src="images/factory-farm-large-img.jpg" class="img-responsive zoom_img_effect" alt="agriculture-image">
                     </span>
                  </div>
               </div>
               ...
               <div class="wdt-100 marbtm50">
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                     <h3 class="marbtm30">factory farm</h3>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                     ...
                     <img src="images/factory-right-img.jpg" class="img-responsive zoom_img_effect" alt="agriculture-image">
                     </span>
                  </div>
               </div>
               <div class="wdt-100">
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                     <span class="scope-img image_hover">
                     <img src="images/farm-scope-img.jpg" class="img-responsive zoom_img_effect" alt="agriculture-image">
                     </span>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">

...
<html lang="zxx">
   ...
   <body>
         ...
         <div class="container">
            <div class="row ">
               <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 display-block ">
                  <a href="index" class="logo"><img src="images/logo.png" class="img-responsive" alt="logo"></a>
               </div>
         ...
         <nav id="main-navigation-wrapper" class="navbar navbar-default ">
            <div class="container">
               <div class="navbar-header">
                  <div class="logo-menu"><a href="index"><img src="images/white-logo.png" alt="logo"></a></div>
                  ...
                  <ul class="nav navbar-nav">
                     <li class="dropdown ">
                        ...
                        <ul class="dropdown-submenu">
                              <li><a href="index2">Home Page 2</a></li>
                              ...
                              <li><a href="index8">Home Page 8</a></li>
                           </ul>
                     </li>
                     <li class="dropdown">
                     ...
                     <li class="dropdown">
                        <a href="portfolio-2" class="active">Portfolio</a><i class="fa fa-chevron-down"></i>
                        <ul class="dropdown-submenu">
                           <li><a href="portfolio-3">Project 3</a></li>
                           <li><a href="portfolio-4">Project 4</a></li>
                           <li><a href="portfolio-5">Project 5</a></li>
                        </ul>
                     </li>
                     <li class="dropdown">
                        <a href="blog">Blog</a><i class="fa fa-chevron-down"></i>
                        <ul class="dropdown-submenu">
                     ...
                     <li class="dropdown">
                        <a href="shop">shop</a><i class="fa fa-chevron-down"></i>
                        <ul class="dropdown-submenu">
            ...
            <div class="row">
               <div class="wdt-100">
                  <div class="col-md-12">
                     ...
                     <img src="images/electronical-large-img.jpg" class="img-responsive zoom_img_effect" alt="agriculture-image">
                     </span>
                  </div>
               </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12 black-portfolio-left">
                     <ul>
                        ...
                        <li>
                           ...
                           <span class="colrght">indofact.com</span>
                        </li>
                        <li>
               ...
               <div class="col-md-12 marbtm50 wdt-100">
                  <h3 class="marbtm30">PetroChemicals</h3>
               ...
               <div class="wdt-100">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                     ...
                     <img src="images/agricultural-scope-img.jpg" class="img-responsive zoom_img_effect" alt="work-scope-image">
                     </span>
                  </div>
               </div>
            </div>
      ...
      <!--=========petrochemical Section end============-->
      <!--=========Footer Start============-->
      <footer>
         <div class="yellow-background solution-available text-center">
            <div class="container">
               <h5>For Any Solution We Are <span>Available</span> For You</h5>
               <a data-animation="animated fadeInUp" class="header-requestbtn contactus-btn hvr-bounce-to-right" href="contact">Contact us</a>
            </div>
         </div>
            ...
            <div class="container">
               ...
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12 ftr-follow-column pull-right">
                     ...
                     <span class="ftr-logo img"><img src="images/ftr-logo.png" class="img-responsive" alt="logo-image"></span>
                  </div>
               </div>
